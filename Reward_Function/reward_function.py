...
class Reward:
    ...
    def reward_function(self, params):
        ...
        # 循環リストの開始インデックスと終了インデックスの間にあるインデックスを返します。
        # (開始インデックスが含まれ、終了インデックスは含まれない)
        ...
        # スペインのコースに最適なレーシングライン
        # 各行 [x,y,速度,時間(前点からの距離)]。
